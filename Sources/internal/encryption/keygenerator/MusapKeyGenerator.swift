...
public class MusapKeyGenerator: KeyGenerator {
    ...
    public static func hkdfStatic(_ useAes256: Bool) throws -> String {
        ...
        AppLogger.shared.log("MacKeyData b64: \(macKeyData.base64EncodedString())")
        AppLogger.shared.log("TransportKeyData b64: \(encKeyData.base64EncodedString())")

        AppLogger.shared.log("MacKey: \(macKeyData)")
        AppLogger.shared.log("TransportKey: \(encKeyData)")
